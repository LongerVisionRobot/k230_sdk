...
单独执行步骤：
    1. 进入sdk构建的容器存放run.cc的目录下 执行 /opt/toolchain/Xuantie-900-gcc-linux-glibc-x86_64/bin/riscv64-unknown-linux-gnu-g++ -O3 llama_run.cc -o llama_run -lm 编译llama_run.cc 文件。
